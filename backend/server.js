...
const app = require("./app"); // pour importer le app.js qui est dans le meme dossier
const server = http.createServer(app); //on va passer cette application à notre server
